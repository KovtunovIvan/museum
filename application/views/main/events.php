<header class="masthead" style="background-image: url('/public/images/events.jpg')">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                <div class="site-heading">
                    <h1 class="text-shadow">Таганрогский<br>политехнический музей</h1>
                    <span class="subheading text-shadow">Мероприятия</span>
                </div>
            </div>
        </div>
    </div>
